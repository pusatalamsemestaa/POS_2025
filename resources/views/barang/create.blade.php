...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('barang') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                <label class="col-1 control-label col-form-label">barang_id</label>
                <div class="col-11">
            ...
            <div class="form-group row">
                <label class="col-1 control-label col-form-label">kategori_id</label>
                <div class="col-11">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="password" class="form-control" id="harga_beli" name="harga_beli" required>
                    @error('harga_beli')
                    <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="password" class="form-control" id="harga_jual" name="harga_jual" required>
                        @error('harga_jual')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    ...
                    <a class="btn btn-default btn-sm" href="{{ url('barang') }}">Kembali</a>
                </div>
            </div>
        </form>
    </div>
