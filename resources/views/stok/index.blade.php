        ...
        {{-- <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Filter berdasarkan suplier</small>
                </div>
            </div>
        </div> --}}
    ...
    <script>
        ...
        $(document).ready(function () {
            dataStok = $('#table_stok').DataTable({
                ...
                {
                    // Menampilkan nama suplier (asumsikan relasi: stok -> suplier)
                    data: 'suplier.suplier_nama',
                    render: function (data, type, row) {
                        return row.suplier ? row.suplier.suplier_nama : 'Terjual';
                    }
                },
                // kolom lainnya
            ...
            $('#barang_id, #user_id, #suplier_id').on('change', function () {
