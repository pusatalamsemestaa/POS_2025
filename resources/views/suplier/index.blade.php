    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('/suplier/import') }}')" class="btn btn-info">Import Kategori</button>
                ...
                <a href="{{ url('/suplier/export_excel') }}" class="btn btn-primary"><i class="fa fa-file-excel"></i> Export
                    suplier</a>
                <a href="{{ url('/suplier/export_pdf') }}" class="btn btn-warning"><i class="fa fa-file-pdf"></i> Export
                    suplier</a>
                <button onclick="modalAction('{{ url('/suplier/create_ajax') }}')" class="btn btn-success">Tambah
                    Ajax</button>
            </div>
        </div>
        <div class="card-body">
